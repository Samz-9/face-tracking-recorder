...
//                 try {
//                     localStorage.setItem('face-video', base64data)
//                     console.log('Video saved to localStorage.')
//                 } catch (e) {
//                     console.error('LocalStorage save failed (too large?)', e)
//                 }
...
//         const videoData = localStorage.getItem('face-video')
//         if (videoData) {
//             const a = document.createElement('a')
//             a.href = videoData
//             a.download = `face-detection-${Date.now()}.webm`
//             a.click()
//         } else {
//             alert("No saved video found in localStorage.")
//         }
//     }
